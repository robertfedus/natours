...
exports.login = catchAsync(async (req, res, next) => {
  const { email, password } = req.body; // e acelasi lucru ca: const email = req.body.email
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!freshUser) {
    // prettier-ignore
    return next(new AppError('The user belonging to this token use does no longer exist.', 401));
  }
